...
(function (domGlobals) {
    ...
    var friendlyServiceErrors = [
      {
        type: 'key_missing',
        message: 'The request did not include an api_firm key.'
      },
      {
        type: 'key_not_found',
        message: 'The provided api_firm key could not be found.'
      },
      {
        type: 'domain_not_trusted',
        message: 'The api_firm key is not valid for the request origins.'
      }
    ];
